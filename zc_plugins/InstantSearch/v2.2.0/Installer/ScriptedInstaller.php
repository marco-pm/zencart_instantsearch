    ...
    protected function executeInstall()
    {
        ...
        $sql =
            "INSERT INTO " . TABLE_CONFIGURATION . "
                ...
                ('Search Product Description', 'INSTANT_SEARCH_INCLUDE_PRODUCT_DESCRIPTION', 'true', 'Search also into the product descriptions. Set to false to improve Instant Search performance.', $cgi, now(), 0, NULL, 'zen_cfg_select_option(array(\'true\', \'false\'),'),
