    ...
    protected function createConfigurationSettings(int $configurationGroupId): void
    {
        ...
        $sql = "
            ...
            VALUES
                ...
                ('[Typesense] Host', 'INSTANT_SEARCH_TYPESENSE_HOST', 'localhost', 'Typesense Host', $configurationGroupId, now(), 2300, NULL, NULL, NULL),
                ('[Typesense] Port', 'INSTANT_SEARCH_TYPESENSE_PORT', '8108', 'Typesense Port', $configurationGroupId, now(), 2400, NULL, NULL, '{\"error\":\"TEXT_INSTANT_SEARCH_CONFIGURATION_INT_VALIDATE\",\"id\":\"FILTER_VALIDATE_INT\",\"options\":{\"options\":{\"min_range\":0}}}'),
                ('[Typesense] Protocol', 'INSTANT_SEARCH_TYPESENSE_PROTOCOL', 'http', 'Typesense Protocol', $configurationGroupId, now(), 2500, NULL, 'zen_cfg_select_option(array(\'http\', \'https\'),', NULL),
                ('[Typesense] Key', 'INSTANT_SEARCH_TYPESENSE_KEY', 'xyz', 'Typesense Key', $configurationGroupId, now(), 2600, NULL, NULL, '{\"error\":\"ERROR\",\"id\":\"FILTER_SANITIZE_URL\",\"options\":{\"options\":{}}}')
        ";
        $this->executeInstallerSql($sql);
    }
