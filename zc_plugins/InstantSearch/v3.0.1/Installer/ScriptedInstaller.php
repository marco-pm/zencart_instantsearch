    ...
    protected function createConfigurationSettings(int $configurationGroupId): void
    {
        ...
        $sql = "
            ...
            VALUES
                ...
                ('Dropdown - Maximum Number of Results', 'INSTANT_SEARCH_DROPDOWN_MAX_RESULTS', '5', 'Maximum number of results displayed in the dropdown.', $configurationGroupId, now(), 600, NULL, NULL, '{\"error\":\"TEXT_INSTANT_SEARCH_CONFIGURATION_INT_VALIDATE\",\"id\":\"FILTER_VALIDATE_INT\",\"options\":{\"options\":{\"min_range\":0}}}'),
