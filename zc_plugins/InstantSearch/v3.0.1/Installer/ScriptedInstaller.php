...
class ScriptedInstaller extends ScriptedInstallBase
{
    ...
    protected function createConfigurationSettings(int $configurationGroupId): void
    {
        ...
        $sql = "
            ...
            VALUES
                ('Dropdown - Enable','INSTANT_SEARCH_DROPDOWN_ENABLED', 'true', 'When the user types into an input search box, display a dropdown with autocomplete search results.', $configurationGroupId, now(), 0, NULL, 'zen_cfg_select_option(array(\'true\', \'false\'),', NULL),
                ('Listing Page - Enable', 'INSTANT_SEARCH_PAGE_ENABLED', 'true', 'When the user submits a search form (excluding the advanced search form), display the search results on a product listing page with infinite scroll.<br>This does not replace the (formerly advanced) search and results page.', $configurationGroupId, now(), 50, NULL, 'zen_cfg_select_option(array(\'true\', \'false\'),', NULL),
                ...
                ('Dropdown - Minimum Length of Search Query', 'INSTANT_SEARCH_DROPDOWN_MIN_WORDSEARCH_LENGTH', '3', 'Minimum number of characters requested for the dropdown to be displayed.', $configurationGroupId, now(), 200, NULL, NULL, '{\"error\":\"TEXT_INSTANT_SEARCH_CONFIGURATION_INT_VALIDATE\",\"id\":\"FILTER_VALIDATE_INT\",\"options\":{\"options\":{\"min_range\":0}}}'),
                ('Dropdown - Maximum Length of Search Query', 'INSTANT_SEARCH_DROPDOWN_MAX_WORDSEARCH_LENGTH', '100', 'Maximum number of characters requested for the dropdown to be displayed.', $configurationGroupId, now(), 250, NULL, NULL, '{\"error\":\"TEXT_INSTANT_SEARCH_CONFIGURATION_INT_VALIDATE\",\"id\":\"FILTER_VALIDATE_INT\",\"options\":{\"options\":{\"min_range\":0}}}'),
                ('Dropdown - Fields to Search and Order', 'INSTANT_SEARCH_DROPDOWN_FIELDS_LIST', 'model-exact,name-description,model-broad,meta-keywords,category,manufacturer', 'List of the fields to search, separated by comma. You can exclude a field from the search by not including in the list.<br>The list also determines the order in which fields are searched, and therefore the position in the results. E.g. putting <code>model-exact</code> before <code>name-description</code> will show results where the model is equal to the query first, and then products that have name or description that contains the query.<br><br>List of fields:<ul><li><b>name-description</b> (product name and description) OR <b>name</b> (product name only, don\\'t search in descriptions) – only ONE of the two</li><li><b>model-exact</b> (product model - exact match, the query contains only and exactly the model)</li><li><b>model-broad</b> (product model - broad match, the query contains also the model or part of it)</li><li><b>meta-keywords</b> (product keywords meta tag)</li><li><b>category</b> (category name)</li><li><b>manufacturer</b> (manufacturer name)</li></ul>Default: <code>model-exact,name-description,model-broad,meta-keywords,category,manufacturer</code><br>', $configurationGroupId, now(), 300, NULL, NULL, '{\"error\":\"TEXT_INSTANT_SEARCH_CONFIGURATION_FIELDS_LIST_VALIDATE\",\"id\":\"FILTER_CALLBACK\",\"options\":{\"options\":[\"\\\\\\\\Zencart\\\\\\\\Plugins\\\\\\\\Admin\\\\\\\\InstantSearch\\\\\\\\InstantSearchConfigurationValidation\",\"validateFieldsListDropdown\"]}}'),
                ...
                ('Dropdown - Highlight Search Terms in Bold', 'INSTANT_SEARCH_DROPDOWN_HIGHLIGHT_TEXT', 'autocomplete', '<strong>none</strong>: no highlight<br><strong>query</strong>: highlight the user search terms<br><strong>autocomplete</strong>: highlight the autocompleted text', $configurationGroupId, now(), 750, NULL, 'zen_cfg_select_option(array(\'none\', \'query\', \'autocomplete\'),', NULL),
                ...
                ('Listing Page - Number of Results per Ajax Call', 'INSTANT_SEARCH_PAGE_RESULTS_PER_PAGE', '10', 'Number of products displayed every time a new \"batch\" of search results is loaded while scrolling the page.', $configurationGroupId, now(), 900, NULL, NULL, '{\"error\":\"TEXT_INSTANT_SEARCH_CONFIGURATION_INT_VALIDATE\",\"id\":\"FILTER_VALIDATE_INT\",\"options\":{\"options\":{\"min_range\":0}}}'),
                ('Listing Page - Maximum Number of Results', 'INSTANT_SEARCH_PAGE_RESULTS_PER_SCREEN', '500', 'Maximum number of search results for the listing page.', $configurationGroupId, now(), 910, NULL, NULL, '{\"error\":\"TEXT_INSTANT_SEARCH_CONFIGURATION_INT_VALIDATE\",\"id\":\"FILTER_VALIDATE_INT\",\"options\":{\"options\":{\"min_range\":0}}}'),
                ('Listing Page - Fields to Search and Order', 'INSTANT_SEARCH_PAGE_FIELDS_LIST', 'model-exact,name-description,model-broad,meta-keywords', 'List of the fields to search, separated by comma. You can exclude a field from the search by not including in the list.<br>The list also determines the order in which fields are searched, and therefore the position in the results. E.g. putting <code>model-exact</code> before <code>name-description</code> will show results where the model is equal to the query first, and then products that have name or description that contains the query.<br><br>List of fields:<ul><li><b>name-description</b> (product name and description) OR <b>name</b> (product name only, don\\'t search in descriptions) – only ONE of the two</li><li><b>model-exact</b> (product model - exact match, the query contains only and exactly the model)</li><li><b>model-broad</b> (product model - broad match, the query contains also the model of part of it)</li><li><b>meta-keywords</b> (product keywords meta tag)</li></ul>Default: <code>model-exact,name-description,model-broad,meta-keywords</code><br>', $configurationGroupId, now(), 950, NULL, NULL, '{\"error\":\"TEXT_INSTANT_SEARCH_CONFIGURATION_FIELDS_LIST_VALIDATE\",\"id\":\"FILTER_CALLBACK\",\"options\":{\"options\":[\"\\\\\\\\Zencart\\\\\\\\Plugins\\\\\\\\Admin\\\\\\\\InstantSearch\\\\\\\\InstantSearchConfigurationValidation\",\"validateFieldsListPage\"]}}'),
