    ...
    protected function createConfigurationSettings(int $configurationGroupId): void
    {
        ...
        $sql = "
            ...
            VALUES
                ...
                ('Dropdown - Highlight Search Terms in Bold', 'INSTANT_SEARCH_DROPDOWN_HIGHLIGHT_TEXT', 'autocomplete', '<code>none</code>: no highlight<br><code>query</code>: highlight the user search terms<br><code>autocomplete</code>: highlight the autocompleted text', $configurationGroupId, now(), 750, NULL, 'zen_cfg_select_option(array(\'none\', \'query\', \'autocomplete\'),', NULL),
