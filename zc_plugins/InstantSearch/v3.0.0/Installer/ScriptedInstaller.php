    ...
    protected function executeInstall()
    {
        ...
        $sql = "
            ...
            VALUES
                ...
                ('Listing Page - Number of Results per Page', 'INSTANT_SEARCH_PAGE_RESULTS_PER_PAGE', '10', 'Number of products per page displayed in the search results listing page.', $cgi, now(), 850, NULL, NULL),
