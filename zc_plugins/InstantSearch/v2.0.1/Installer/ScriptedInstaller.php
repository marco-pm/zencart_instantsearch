    ...
    protected function executeInstall()
    {
        ...
        $sql =
            "INSERT IGNORE INTO " . TABLE_CONFIGURATION . "
                ...
                ('Waiting time after typing', 'INSTANT_SEARCH_INPUT_WAIT_TIME', '50', 'Waiting time (in milliseconds) after the user has stopped typing before the search is performed. Increase the value a little if you want to avoid too many POST requests on your server in a short interval.', $cgi, now(), 130, NULL, NULL),
