    ...
    protected function executeInstall()
    {
        ...
        $sql =
            "INSERT IGNORE INTO " . TABLE_CONFIGURATION . "
                ...
                ('Max length of input text', 'INSTANT_SEARCH_MAX_WORDSEARCH_LENGTH', '100', 'Maximum length of text for Instant Search. If the text entered by the user has more characters than this value, the instant search won\'t be performed.', $cgi, now(), 120, NULL, NULL),
                ('Waiting time after typing', 'INSTANT_SEARCH_INPUT_WAIT_TIME', '50', 'Waiting time (in milliseconds) after the user has stopped typing before the search is performed. Increase this value a little if you want to avoid too many POST requests on your server in a short interval.', $cgi, now(), 130, NULL, NULL),
